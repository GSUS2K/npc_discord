...
CREATE TABLE IF NOT EXISTS user_state (
  guild_id TEXT NOT NULL, user_id TEXT NOT NULL, last_catchup_at TEXT, reply_style TEXT NOT NULL DEFAULT 'normal', preferences TEXT NOT NULL DEFAULT '{}', PRIMARY KEY(guild_id,user_id)
);
